      ...
      <div className="relative z-10 flex h-full items-end p-8 lg:p-16">
        <div className="max-w-2xl">
          ...
          <div className="flex gap-4 animate-fade-in">
            <button className="flex items-center gap-2 rounded-lg bg-white px-8 py-3 font-semibold text-black transition-all hover:bg-gray-200 hover:scale-105">
              <Play size={20} fill="currentColor" />
              Play
            </button>
            <button className="flex items-center gap-2 rounded-lg bg-gray-600/50 px-8 py-3 font-semibold text-white backdrop-blur-sm transition-all hover:bg-gray-600/70 hover:scale-105">
              <Info size={20} />
              More Info
            </button>
          </div>
