      ...
      <div className="relative w-full max-w-4xl rounded-lg bg-gray-900 shadow-2xl animate-scale-in">
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3">
            <button 
              onClick={handlePlay}
              className="flex items-center gap-2 rounded-lg bg-white px-6 py-3 font-semibold text-black transition-all hover:bg-gray-200 hover:scale-105"
            >
            ...
            <button 
              ...
              className="flex items-center gap-2 rounded-lg bg-gray-700 px-6 py-3 font-semibold text-white transition-all hover:bg-gray-600 hover:scale-105"
            >
              <Plus size={20} />
              My List
            </button>
